...
class Memory(object):
    ...
    def append(self, observation, action, reward, terminal, training=True):
        ...
        #print(self.recent_observations)
    ...
    def get_recent_state(self, current_observation):
        ...
        #state = self.recent_observations
        ...
        #print("state",state,len(self.recent_observations))
        return state
...
class CustomerSequentialMemory(SequentialMemory):
    def sample(self, batch_size, batch_idxs=None):
        ...
        for idx in batch_idxs:
            ...
            state1 = [np.copy(x) for x in state0[1:]]
            print(state1)
            print(list(self.observations[idx][:2]))
            state1.append(state0)
